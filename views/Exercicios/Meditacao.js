    ...
    return (
        <View style={{backgroundColor:'#fff', justifyContent:'center',alignItems: 'center'}}>
            ...
            <ScrollView style={{marginHorizontal:20}}>
                <View style={{backgroundColor:'#fff', justifyContent:'center',alignItems: 'center', marginBottom:20}}>
                    ...
                    Concentre-se do início ao fim de cada inspiração e expiração. Concentrar-se no movimento da respiração através das narinas ou no movimento rítmico do abdômen ou do tórax o ajudará a manter o foco. {"\n"}</Text>
                    ...
                    Comece rotulando-o de “distração”. Você gradualmente mudará para “pensamento”, “sentimento” ou “sensação” conforme sua consciência melhora.{"\n"}{"\n"} E, por fim, pensamento específico: “Estou ansioso com o futuro” ou emoção específica: “raiva”. Depois de reconhecer o que o distraiu, concentre-se novamente na respiração e continue contando. </Text>
                </View>
            </ScrollView>
