    ...
    return (
        <View style={{backgroundColor:'#fff', justifyContent:'center',alignItems: 'center'}}>
            ...
            <ScrollView style={{marginHorizontal:20,marginTop:10}}>
                <View style={{backgroundColor:'#fff', justifyContent:'center',alignItems: 'center'}}>
                    <Text style={{marginBottom:8, fontSize:16, lineHeight:20}}>1.Sente-se: Endireite as costas, permita-se relaxar um pouco e descanse em uma posição em que sua postura seja boa, sem ficar tenso ou rígido. </Text>
                    <Image style={{ justifyContent:'center',alignItems: 'center', width:250, height:250}} source={require('./imagens/sentar.jpg')}/>
                    <Text style={{marginTop:8, fontSize:16, lineHeight:20}}>2. Volte sua atenção para sua respiração: A simples observação da respiração acalma automaticamente o corpo e a mente e, como resultado, alonga e aprofunda a respiração. 
